...
from habit.view.pleasant_habit import PleasantHabitListAPIView, PleasantHabitCreateAPIView, \
    PleasantHabitRetrieveAPIView, PleasantHabitDestroyAPIView, PleasantHabitUpdateAPIView, \
    PleasantHabitPublishedListAPIView
from habit.view.unpleasant_habit import UnpleasantHabitListAPIView, UnpleasantHabitCreateAPIView, \
